...
Public Class frmExample
    ...
    Private Sub frmExample_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'end set screen
        'pbxPointer.Location() = frmMain.pntLastExample
        KeyPreview = True
    ...
    Private Sub frmExample_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        Else
            If e.KeyChar = "2" Then
                Select Case trbExample.Value
                    Case Is > 99
                        trbExample.Value = 100
                    Case Else
                        trbExample.Value = trbExample.Value + 1
                End Select
                intPointer = trbExample.Value
            Else
                If e.KeyChar = "1" Then
                    Select Case trbExample.Value
                        Case Is < 1
        ...
        If e.KeyChar = "8" Then
            ...
            Else
                ...
                sr.WriteLine(Now & " " & "Understand" & "  " & trbExample.Value)

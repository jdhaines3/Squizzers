...
Public Class frmEnjoy
    ...
    Private Sub btnEnjoy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnjoy.Click
        ...
        Else
            ...
            frmMain.ChangeDegree = trbEnjoy.Value
            trbEnjoy.Value = 50
    ...
    Private Sub trbEnjoy_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles trbEnjoy.DragDrop

...
Public Class frmPacsQ1

    Dim subID, path, cbx As String

    Private Sub frmPacsQ1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub frmPacsQ1_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        ElseIf e.KeyChar = "8" Then
            ...
            sr.WriteLine(Now & ",PacsQ1," & Number.Text)
            sr.Close()
            fs.Close()
            lblCrave.Focus()
            Me.Hide()

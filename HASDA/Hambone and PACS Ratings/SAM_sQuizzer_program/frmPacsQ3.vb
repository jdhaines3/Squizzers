...
Public Class frmPacsQ3

    Dim path, subID, cbx As String


    Private Sub frmPacsQ3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub frmPacsQ3_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        ElseIf e.KeyChar = "8" Then
            ...
            sr.WriteLine(Now & ",PacsQ3," & Number.Text)
            sr.Close()
            fs.Close()
            lblCrave.Focus()
            Me.Hide()

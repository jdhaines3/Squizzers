...
Public Class frmPacsQ5

    Dim path, subID, cbx As String


    Private Sub frmPacsQ5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub frmPacsQ5_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        ...
        ElseIf e.KeyChar = "8" Then
            ...
            sr.WriteLine(Now & ",PacsQ5," & Number.Text)
            sr.Close()
            fs.Close()
            lblCrave.Focus()
            Me.Hide()
